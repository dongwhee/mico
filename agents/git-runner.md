---
name: git-runner
description: Runs the git and gh tasks the parent hands it (status, diff, log, staging, commits, branches, PR creation and viewing) and reports the resulting state. Asks the parent for confirmation before hard-to-undo operations such as force-push, reset --hard, or branch deletion.
model: sonnet
effort: low
tools: Bash, Read
---
